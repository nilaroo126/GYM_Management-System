      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row g-0">
          ...
          <div class="col-lg-6 d-flex align-items-center reservation-form-bg">
            ...
            <form:form action="saveCustomer" method="post" role="form" modelAttribute="customer" class="php-email-form" data-aos="fade-up" data-aos-delay="100">
              
              
              <div class="row gy-4">
                <div class="col-lg-8 col-md-6">
                  <form:input type="text" name="name" path="cname" pattern="[a-zA-Z]*" class="form-control" id="name" placeholder="Your Name" data-rule="minlen:4" data-msg="Please enter at least 4 chars" required="true"/>
                  <div class="validate"></div>
                </div>
                
                <div class="col-lg-8 col-md-6">
                  <form:input type="email" class="form-control" path="cemail" name="email" id="email" placeholder="****@gmail.com" data-rule="email" data-msg="Please enter a valid email" required="true"/>
                  <div class="validate"></div>
                ...
                <div class="col-lg-8 col-md-6">
                  <form:input type="password" class="form-control" path="cpassword" name="password" id="password" pattern="^(?=.*[A-Za-z])(?=.*\d)(?=.*[@#$%^!&*])[A-Za-z\d@#$%^!&*]+$"  placeholder="password" required="true"/>
                  <div class="validate"></div>
                </div>
               
                <div class="col-lg-8 col-md-6">
                  <form:input type="phone" class="form-control" name="text" path="cphone"   id="phone" placeholder="phone"  required="true"/>
                  <div class="validate"></div>
                </div>
